...
### `call-chain/`
5-file cross-file call chain (`entry` → `step02` → ... → `step05`).

**E2E tests for:** `dependenciesOf`, `dependentsOf`, `pathsBetween`
- Forward dependency traversal
- Reverse dependency traversal
- Path finding between symbols
- Chain-compacted graph output

**Benchmarks:** All 3 tools (`dependenciesOf`, `dependentsOf`, `pathsBetween`)
...
**Benchmarks:** `pathsBetween`, `dependenciesOf`
...
**E2E tests for:** `dependenciesOf`, `dependentsOf`, `pathsBetween`
- Cross-package dependency traversal
...
**Benchmarks:** `dependentsOf`, `dependenciesOf`
...
**E2E tests for:** `pathsBetween` with REFERENCES edges
...
**Benchmarks:** `pathsBetween` with REFERENCES edges (multi-hop through stored functions)

**Status:** ✅ Correctly tests REFERENCES edges via `pathsBetween` tool
